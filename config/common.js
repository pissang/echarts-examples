...
module.exports = {
    cdnThirdParty: {
        ...
        echartsMinJS: 'https://cdn.jsdelivr.net/npm/echarts/dist/echarts.min.js',
        echartsDir: 'https://cdn.jsdelivr.net/npm/echarts',
        ...
        aceDir: 'https://cdn.jsdelivr.net/npm/ace-builds/src',
